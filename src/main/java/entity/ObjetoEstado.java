 ...
 */
@Entity
@Table(name = "objeto_estado", catalog = "bachesTPI", schema = "public")
@NamedQueries({
...
public class ObjetoEstado implements Serializable {
    ...
    public ObjetoEstado(Long idObjetoEstado, Boolean actual, Date fechaAlcanzado, String observaciones, Estado idEstado, Objeto idObjeto) {
    ...
    public String toString() {
        return "com.mycompany.bachesjpa.entity.ObjetoEstado[ idObjetoEstado=" + idObjetoEstado + " ]";
    }
