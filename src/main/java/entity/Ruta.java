 ...
 */
@Entity
@Table(name = "ruta", catalog = "bachesTPI", schema = "public")
@NamedQueries({
...
public class Ruta implements Serializable {
    ...
    public Ruta(Long idRuta, String nombre, Date fechaCreacion, String observaciones) {
        this.idRuta = idRuta;
        this.nombre = nombre;
    ...
    public String toString() {
        return "com.mycompany.bachesjpa.entity.Ruta[ idRuta=" + idRuta + " ]";
    }
